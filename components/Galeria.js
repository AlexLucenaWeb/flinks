...
const Galeria = ( props ) => {
    ...
    return (
        <div data-component='Galeria' id='galeria' className='w-full flex py-10 sm:py-20 justify-center bg-blue'>
            <div id="full_image" onClick={closeImageHandler} className='w-screen h-screen bg-black bg-opacity-90 fixed top-0 right-0 overflow-auto flex items-center justify-center z-50 hidden'>
            </div>
