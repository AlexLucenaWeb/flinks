        ...
        <div data-component='Contacto' id='contacto' className='w-full flex pt-10 sm:pt-20 pb-20 justify-center'>
            <div className='w-full lg:max-w-6xl px-5 xl:px-2 text-yellow'>
                ...
                <div className="flex sm:hidden gap-4 justify-evenly">
                        <a href="https://www.instagram.com/flinksofficial/" target="_blank" rel="noreferrer"className="transition duration-200 transform hover:scale-105">
                            <img src={instagranLogo.src} width="70" height="70"/>
                        </a>
                        <a href="https://open.spotify.com/artist/4oFz4w82DzzoT19TsPvA48" target="_blank" rel="noreferrer"className="transition duration-200 transform hover:scale-105">
                            <img src={spotifyLogo.src} width="70" height="70"/>
                        </a>                        
                        <a href="https://www.youtube.com/channel/UCxbK88JmUvrDmGMzJ5yzRcQ" target="_blank" rel="noreferrer"className="transition duration-200 transform hover:scale-105">
